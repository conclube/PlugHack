        ...
        if(command.getLabel().equalsIgnoreCase("nofall")) {
           if(commandSender instanceof Player) {
               if(commandSender.hasPermission("PlugHack.NoFall")) {
                   ...
                   if(targetPlayer.getPersistentDataContainer().getOrDefault(new NamespacedKey(plugin,"nofall"), PersistentDataType.STRING, "false").equals("true")) {
                       ...
                       targetPlayer.getPersistentDataContainer().set(new NamespacedKey(plugin, "nofall"), PersistentDataType.STRING, "true");
